...
Companion for an 80-paper IEEE-style survey of enterprise data retrieval: [github.com/shariftasrik/sql_vs_document_RAG](https://github.com/shariftasrik/sql_vs_document_RAG). The repo answers **when to use SQL, document RAG, hybrid, or GraphRAG**. It does not train a new model. Reported metrics stay with their original papers and are not mixed on one leaderboard.
